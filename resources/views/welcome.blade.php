            ...
            <div class="main-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="https://demo.smartcart.shopping/en/admin/product">
                                <div class="card card-yellow text-white">
                                    ...
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col-8">
                                                <h3 class="mb-0 count" id="productCount">7696</h3>
                                                <p class="mb-0">Total</p>
                                            </div>

                                            <div class="col-4 text-right">
                                                <i class="fab fa-product-hunt f-30"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <a href="https://demo.smartcart.shopping/en/admin/customer">
                                <div class="card card-blue text-white">
                                    ...
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col-8">
                                                <h3 class="mb-0 count" id="customerCount">1810</h3>
                                                <p class="mb-0">Total</p>
                                            </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <a href="https://demo.smartcart.shopping/en/admin/active/driver">
                                <div class="card card-green text-white">
                                    ...
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col-4">
                                                <h3 class="mb-0 count" id="activeDriverCount">23</h3>
                                                <p class="mb-0">Total</p>
                                            </div>
                                            <div class="col-4">
                                                <h3 class="mb-0 count" id="activeDriverCount">2</h3>
                                                <p class="mb-0">Pending</p>
                                            </div>
                                            <div class="col-4 text-right">
                                                <i class="fas fa-car f-30"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <a href="https://demo.smartcart.shopping/en/admin/merchant">
                                <div class="card card-red text-white">
                                    ...
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col-8">
                                                <h3 class="mb-0 count" id="customerCount">143</h3>
                                                <p class="mb-0">Total</p>
                                            </div>
                                            <div class="col-4 text-right">
                                                <i class="fas fa-truck f-30"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="container-fluid">
                    <div class="row clearfix">
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="https://demo.smartcart.shopping/en/admin/order">
                                <div class="card card-red text-white">
                                    <div class="card-header">
                                    ...
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col-4">
                                                <h3 class="mb-0 count" id="merchantCount">0</h3>
                                                <p class="mb-0">Total</p>
                                            </div>
                                            ...
                                            <div class="col-4 text-right">
                                                <i class="fas fa-cart-plus f-30"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="https://demo.smartcart.shopping/en/admin/merchants-tawseleh">
                                <div class="card card-green text-white">
                                    <div class="card-header">
                                        <h5 class="mb-0">Merchant Tawseleh</h5>
                                    </div>
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col-4">
                                            ...
                                            <div class="col-4">
                                                <h3 class="mb-0 count" id="merchantCount">0
                                                </h3>
                                                <p class="mb-0">Pending</p>
                                            </div>
                                            <div class="col-4 text-right">
                                                <i class="fas fa-people-carry f-30"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="https://demo.smartcart.shopping/en/admin/anythingOrder">
                                <div class="card card-blue text-white">
                                    <div class="card-header">
                                        <h5 class="mb-0">Anything Order</h5>
                                    </div>
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col-4">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="https://demo.smartcart.shopping/en/admin/tawseleh">
                                <div class="card card-yellow text-white">
                                    <div class="card-header">
                                        <h5 class="mb-0">Tawseleh</h5>
                                    </div>
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col-4">
                                            ...
                                            <div class="col-4 text-right">
                                                <i class="fas fa-motorcycle f-30"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="https://demo.smartcart.shopping/en/admin/offers">
                                <div class="widget">
                                    <div class="widget-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="state">
                                                <h6>Offers</h6>
                                                <h2 class="mb-0 count" id="merchantCount">5</h2>
                                            </div>
                                            <div class="icon">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="https://demo.smartcart.shopping/en/admin/feedback">
                                <div class="widget">
                                    <div class="widget-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="state">
                                                <h6>Feedbacks</h6>
                                                <h2 class="mb-0 count" id="merchantCount">2</h2>
                                            </div>
                                            <div class="icon">
                                                <i class="fas fa-comment-dots f-30"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="https://demo.smartcart.shopping/en/admin/support">
                                <div class="widget">
                                    <div class="widget-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="state">
                                                <h6>Customer Support Message</h6>
                                                <h2 class="mb-0 count" id="merchantCount">349</h2>
                                            </div>
                                            <div class="icon">
                                                <i class="fas fa-comment-alt f-30"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="https://demo.smartcart.shopping/en/admin/coupon">
                                <div class="widget">
                                    <div class="widget-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="state">
                                                <h6>Coupons</h6>
                                                <h2 class="mb-0 count" id="merchantCount">1</h2>
                                            </div>
                                            <div class="icon">
                                                <i class="fas fa-cart-arrow-down f-30"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="list-group row">
                            <a href="javascript:void(0)" class="list-group-item" data-chat-user="Gene Newman">
                                <figure class="user--online">
                                    <img src="https://demo.smartcart.shopping/img/users/1.jpg" class="rounded-circle" alt="">
                                </figure><span><span class="name">Gene Newman</span> <span class="username">@gene_newman</span> </span>
                            </a>
                            <a href="javascript:void(0)" class="list-group-item" data-chat-user="Billy Black">
                                <figure class="user--online">
                                    <img src="https://demo.smartcart.shopping/img/users/2.jpg" class="rounded-circle" alt="">
                                </figure><span><span class="name">Billy Black</span> <span class="username">@billyblack</span> </span>
                            </a>
                            <a href="javascript:void(0)" class="list-group-item" data-chat-user="Herbert Diaz">
                                <figure class="user--online">
                                    <img src="https://demo.smartcart.shopping/img/users/3.jpg" class="rounded-circle" alt="">
                                </figure><span><span class="name">Herbert Diaz</span> <span class="username">@herbert</span> </span>
                            </a>
                            <a href="javascript:void(0)" class="list-group-item" data-chat-user="Sylvia Harvey">
                                <figure class="user--busy">
                                    <img src="https://demo.smartcart.shopping/img/users/4.jpg" class="rounded-circle" alt="">
                                </figure><span><span class="name">Sylvia Harvey</span> <span class="username">@sylvia</span> </span>
                            </a>
                            <a href="javascript:void(0)" class="list-group-item active" data-chat-user="Marsha Hoffman">
                                <figure class="user--busy">
                                    <img src="https://demo.smartcart.shopping/img/users/5.jpg" class="rounded-circle" alt="">
                        ...
                        <div class="widget-chat-activity flex-1">
                            <div class="messages">
                                ...
                                <img src="https://demo.smartcart.shopping/img/users/5.jpg" class="rounded-circle" alt="">
                                    ...
                                    <div class="message-body media-body">
                                        <p>There is a cheesy incarnation waiting for you no matter what you palete preferences are.</p>
                                    </div>
                                </div>
                                <div class="message media">
                                    <figure class="user--online">
